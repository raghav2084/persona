		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form id="paymentForm" method="post" action="savepayment">
					...
					<button class="btn btn-md btn-primary" type="button" data-loading-text="Saving..." id="empPaySubmitButtonID">Submit</button>
...
<%-- 								<td>${i.count}</td> --%>
		...
		<%-- <a class="navbar-brand" >Hello ${paymentsList}!</a> --%>
	</div>
	<!-- /container -->
